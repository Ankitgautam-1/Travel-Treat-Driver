                ...
                child: Hero(
                  ...
                  child: Center(
                    child: ClipRRect(
                      ...
                      child: Image.network(
                          'https://ugxqtrototfqtawjhnol.supabase.in/storage/v1/object/public/travel-treat-storage/Drivers/${Provider.of<AccountProvider>(context, listen: false).userAccount.Uid}/${Provider.of<AccountProvider>(context, listen: false).userAccount.Uid}',
                          width: 100,
                          height: 100,
                          fit: BoxFit.cover),
                    ),
